...
async function main() {
    ...
    console.log(`👤 Colaboradores importados/atualizados: ${totalUsers}`)
    console.log(`📱 Linhas (Chips) importados: ${totalSims}`)
    console.log(`💻 Aparelhos importados: ${totalAssets}`)
    console.log(`🔐 Credenciais (Senhas) importadas pro cofre: ${totalCreds}`)
    console.log("=========================================")
}
